            ...
            modelBuilder.Entity("Employer.Domain.Entities.StudentSubjectMap", b =>
                {
                    ...
                    b.OwnsOne("Employer.Domain.ValueObjects.Note", "Note", b1 =>
                        {
                            b1.Property<int>("StudentSubjectMapId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer")
                                .UseIdentityByDefaultColumn();
                            ...
                            b1.HasKey("StudentSubjectMapId");

                            b1.ToTable("StudentSubjectMap");

                            b1.WithOwner()
                                .HasForeignKey("StudentSubjectMapId");
                        });
            ...
            modelBuilder.Entity("Employer.Domain.Entities.Subject", b =>
                {
                    ...
                    b.OwnsOne("Employer.Domain.ValueObjects.Description", "Description", b1 =>
                        {
                            b1.Property<int>("SubjectId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer")
